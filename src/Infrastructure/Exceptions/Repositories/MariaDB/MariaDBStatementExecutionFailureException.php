...
use Mvreisg\GamebaseBackend\Infrastructure\Exceptions\Repositories\RepositoryStatementExecutionFailureException;

class MariaDBStatementExecutionFailureException extends RepositoryStatementExecutionFailureException
{
